        ...
        <div class="row">
                    <div class="featured-post">
                        <div class="content-post">
                            <h4 class="title" style="font-size: 22px; font-weight:600;">Información Preliminar</h4>
                        </div><!-- /content-post -->
                    </div><!-- /featured-post -->
                    ...
                    <%
                        ...
                        if (request.getParameter("noGrabar") != null) {
                            nombre = request.getParameter("txtnombres");
                            email = request.getParameter("txtemail");
                            celular = request.getParameter("txtcelular");
                            servicio = request.getParameter("txtservicio");
                        } else { // inicio de nuevo proyecto
                            if (request.getParameter("siGrabar") != null);
                            ...
                            try {
                                ...
                                st.executeUpdate("INSERT INTO usuarios (registro, nombres, correo, telefono, servicio) values('0','"+nombre+"','"+email+"','"+celular+"','"+servicio+"');");
                    ...
                    %>
                                    <table >
                                        <tr><th>Nombres</th><th>Correo Electrónico</th> <th>Celular</th> <th>Tipo de Servicio</th>
                                        </tr>
                                        <tr> <td><%=nombre%></td> <td><%=email%></td> <td><%=celular%></td>
                                            <td><%=servicio%>
                                        </tr>
                                    </table><br>
